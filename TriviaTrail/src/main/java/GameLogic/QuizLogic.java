package TriviaTrail.src.main.java.GameLogic;

import TriviaTrail.src.main.java.Categories.*;
import TriviaTrail.src.main.java.Models.Category;
...
//            show choices from questions in questionSet
            ...
            List<String> choiceSet = question.getChoices();
    ...
    public void addQuestion() {
        ...
        if (confirmQuestion()) {
            addQuestionToCategory(userInput, newQ, newChoices, newAnswer);
        } else {
    ...
    public void addQuestionToCategory(int category, String question, String[] choices, String answer) {
        switch (category) {
            case 1:
